...
function App() {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#1f1f1f]">
      ...
      <div className="absolute top-7 left-16 h-44 w-44 [background-image:radial-gradient(#272727_3px,transparent_3px)] [background-size:14px_14px] lg:h-64 lg:w-64"></div>
      <MainSection />
    </div>
  );
}
